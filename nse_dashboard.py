...
with col3:
    ...
    st.components.v1.iframe("https://chartink.com/stocks-new?symbol=NIFTY", height=400, scrolling=True)
with col4:
    st.subheader(f"BANKNIFTY")
    # Embed ChartInk chart for selected timeframe
    st.components.v1.iframe("https://chartink.com/stocks-new?symbol=BANKNIFTY", height=400, scrolling=True)
